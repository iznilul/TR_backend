package slg.trbackend.web.config;
...
import slg.trbackend.common.base.TokenConstant;
import slg.trbackend.web.Interceptor.MainInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(mainInterceptor)
                .addPathPatterns("/**")
                .excludePathPatterns("/**")
                .excludePathPatterns("/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**","/auth/login");
    }
